...
class TestLoader(mx.io.DataIter):
    ...
    def get_batch(self):
        cur_from = self.cur#获取数据的开始位置
        cur_to = min(cur_from + self.batch_size, self.size)#获取数据的截至位置
